          ...
          <div className="relative w-full">
            ...
            <div className="absolute top-[60px] md:top-[150px] left-1/2 -translate-x-1/2 w-[70%] md:w-[60%]">
              <div className="text-center mb-8">
                ...
                <p className="font-cormorant text-[14px] md:text-[28px] text-parchment-ink italic">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative">
                  <label className="font-cinzel text-[14px] md:text-[30px] font-bold text-parchment-crimson tracking-widest uppercase mb-2 block">
                    Name of the Seeker
                  </label>
                  <div className="relative border-b-2 border-parchment-ink/20 focus-within:border-parchment-gold transition-colors">
                    <input
                      ...
                      required
                      className="w-full bg-transparent py-3 font-cormorant text-[18px] md:text-[34px] text-parchment-ink placeholder:text-parchment-ink/60 focus:outline-none"
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      required
                      rows={3}
                      className="w-full bg-transparent py-3 font-cormorant text-[18px] md:text-[34px] text-parchment-ink placeholder:text-parchment-ink/60 focus:outline-none resize-none"
