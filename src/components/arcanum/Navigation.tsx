    ...
    <>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <div className="flex h-16 items-center justify-between md:justify-center gap-3 md:gap-4">
            ...
            >
              <img
                ...
                alt="Milo's Arcanum"
                className="h-20 md:h-24 w-auto group-hover:drop-shadow-[0_0_8px_rgba(212,154,26,0.6)] transition-all duration-300"
              />
            ...
            {/* Styled mobile menu button - gothic themed */}
            <button
              onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
              className="md:hidden shrink-0 w-10 h-10 rounded-lg bg-storm-mist/20 border border-parchment-gold/30 flex items-center justify-center text-parchment-gold hover:text-glow-gold hover:border-parchment-gold/60 hover:shadow-[0_0_10px_rgba(212,154,26,0.3)] transition-all duration-300"
